                                        ...
                                        @foreach(config('translatable.locales') as $locale)
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input required value="{{$player->translate($locale)->name}}" type="text" class="form-control game_name" name="name[{{$locale}}]" placeholder="name {{$locale}}">
                                                    </div>
                                                </div>
                                            </div>
                                        @endforeach
<div class="col-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <input @if( $player->in_home == '1' ) checked @endif required type="checkbox" class="form-control" id="in_home" name="in_home">
                                                </div>
                                            </div>
                                            </div>
